# -*- coding: utf-8 -*-
# Настройки Django для проекта prbbook
import imp, os

# Настройка определяющая когда проект запускается на OpenShift
ON_OPENSHIFT = False
...
if ON_OPENSHIFT:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': 'prbbook',  # Or path to database file if using sqlite3.
            'USER': os.environ['LOCAL_MYSQL_USER'],                      # Not used with sqlite3.
            'PASSWORD': os.environ['LOCAL_MYSQL_PASS'],                  # Not used with sqlite3.
...
EngineManager.add_engine(engine_9.ProblemEngine)
