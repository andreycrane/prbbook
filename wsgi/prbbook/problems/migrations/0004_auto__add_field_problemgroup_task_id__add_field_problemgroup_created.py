...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemGroup.task_id'
        db.add_column(u'problems_problemgroup', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProblemGroup.created'
        db.add_column(u'problems_problemgroup', 'created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemGroup.task_id'
        db.delete_column(u'problems_problemgroup', 'task_id')

        # Deleting field 'ProblemGroup.created'
        db.delete_column(u'problems_problemgroup', 'created')
    ...
    models = {
        ...
        u'problems.problemgroup': {
            ...
            'task_id': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'})
        }
    }
